import bpy
from bpy.types import ShaderNodeTree, NodeGroupOutput, NodeGroupInput, Object, Material
...
def create_shader_lambert():
    group_name = "ms/k Lambert Shader"
...
def create_material(obj: Object, props: MySimsSingleMaterialProps):
    ...
    if props.shader_type == "0x94773578":
...
def create_material_lambert(material: Material, props: MySimsSingleMaterialProps):
    ...
    group_node.node_tree = bpy.data.node_groups["ms/k Lambert Shader"]
